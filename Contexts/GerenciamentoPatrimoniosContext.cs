...
public partial class GerenciamentoPatrimoniosContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AreaID).HasName("PK__Area__70B820285DC99A06");

            entity.HasIndex(e => e.NomeArea, "UQ__Area__9A779760120ABDD7").IsUnique();
        ...
        {
            entity.HasKey(e => e.BairroID).HasName("PK__Bairro__4A093623FCE0C6F5");
            ...
            entity.HasOne(d => d.Cidade).WithMany(p => p.Bairro)
                ...
                .HasConstraintName("FK_Cidade_Bairro");
        });

        modelBuilder.Entity<Cargo>(entity =>
        {
            entity.HasKey(e => e.CargoID).HasName("PK__Cargo__B4E665ED31D92EB9");

            entity.HasIndex(e => e.NomeCargo, "UQ__Cargo__4D9FD7DEFF3536AA").IsUnique();
        ...
        {
            entity.HasKey(e => e.CidadeID).HasName("PK__Cidade__B6800959B8A7638A");
        ...
        {
            entity.HasKey(e => e.EnderecoID).HasName("PK__Endereco__B9D9462F498834A8");
            ...
            entity.Property(e => e.Complemento)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Longradouro)
                .HasMaxLength(50)
                .IsUnicode(false);
        ...
        {
            entity.HasKey(e => e.LocalID).HasName("PK__Local__499359DB556BE99C");
        ...
        {
            entity.HasKey(e => e.LogPatrimonio1).HasName("PK__LogPatri__7E425764FE69A43C");
        ...
        {
            entity.HasKey(e => e.PatrimonioID).HasName("PK__Patrimon__C5A60BDE3E117562");
        ...
        {
            entity.HasKey(e => e.TransferenciaID).HasName("PK__Solicita__E5B4F5F22CCA8B2C");
            ...
            entity.HasOne(d => d.Local).WithMany(p => p.SolicitacaoTransferencia)
                .HasForeignKey(d => d.LocalID)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SolicitacaoTransferencia_LocalID");
            ...
            entity.HasOne(d => d.StatusTransferencia).WithMany(p => p.SolicitacaoTransferencia)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SolicitacaoTransferencia_StatusTranferencia");
            ...
            entity.HasOne(d => d.UsuarioIDSolicitanteNavigation).WithMany(p => p.SolicitacaoTransferenciaUsuarioIDSolicitanteNavigation)
                .HasForeignKey(d => d.UsuarioIDSolicitante)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.StatusPatrimonioID).HasName("PK__StatusPa__B3F336093329E927");

            entity.HasIndex(e => e.Status, "UQ__StatusPa__3A15923FC1E5B0EE").IsUnique();
        ...
        {
            entity.HasKey(e => e.StatusTransferenciaID).HasName("PK__StatusTr__7AA828B9DC00EC20");

            entity.HasIndex(e => e.Status, "UQ__StatusTr__3A15923F75A9C137").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoAlteracaoID).HasName("PK__TipoAlte__9BEF4F0DE91D26E4");

            entity.HasIndex(e => e.Tipo, "UQ__TipoAlte__8E762CB4892A31AF").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoPatrimonioID).HasName("PK__TipoPatr__4DC9FF991355D2C8");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoPatr__7859A10AB4465A32").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoUsuarioID).HasName("PK__TipoUsua__7F22C702F70B2EA3");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoUsua__7859A10A6E0F28B3").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE798B7ED3F5B");

            entity.ToTable(tb => tb.HasTrigger("trg_UsuarioSoftDelete"));

            entity.HasIndex(e => e.RG, "UQ__Usuario__321537C860A6B2FF").IsUnique();

            entity.HasIndex(e => e.CarteiraTrabalho, "UQ__Usuario__6E25BCA2A52F89A2").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534E3909D10").IsUnique();

            entity.HasIndex(e => e.CPF, "UQ__Usuario__C1F897314A380D7C").IsUnique();

            entity.HasIndex(e => e.NIF, "UQ__Usuario__C7DEC330B3C14313").IsUnique();
